    ...
    public function run(): void
    {
        Car::insert([
            [
                ...
                'image_url' => './assets/images/BMW%20M5%20CS%202022.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/Bugatti%20Chiron%20Super%20Sport.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/Ferrari%20Enzo.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/The%20Nissan%20GT-R(R35).jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/Lamborghini%20Huraca╠ün%20STO.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/Rolls-Royce%20Ghost.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/Porsche%20918%20Spyder.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'image_url' => './assets/images/Ferrari%20LaFerrari.jpg',
                'updated_at' => now(),
                'created_at' => now(),
            ],
        ]);
